...
public class NewsletterArticleModelSummaryContributor implements ModelSummaryContributor {
    @Override
    ...
    private Summary createSummary(Document document, String contentField, String titleField) {
