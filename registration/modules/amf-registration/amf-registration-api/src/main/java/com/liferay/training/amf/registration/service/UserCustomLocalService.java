...
public interface UserCustomLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.amf.registration.service.impl.UserCustomLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user custom local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserCustomLocalServiceUtil} if injection and service tracking are not available.
	 */
