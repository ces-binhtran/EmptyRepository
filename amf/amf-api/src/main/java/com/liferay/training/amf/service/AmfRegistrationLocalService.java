...
public interface AmfRegistrationLocalService extends BaseLocalService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.amf.service.impl.AmfRegistrationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the amf registration local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AmfRegistrationLocalServiceUtil} if injection and service tracking are not available.
	 */
	public User addMember(
