...
public interface AmfRegistrationService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.amf.service.impl.AmfRegistrationServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the amf registration remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AmfRegistrationServiceUtil} if injection and service tracking are not available.
	 */
